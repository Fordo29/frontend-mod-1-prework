...
var isHungry = "needs to feed";
var numberOfPets = 1 + 1;
console.log(firstName, isHungry, numberOfPets);
// IN WORDS:
// How did you decide to use the data type you did for each of the three variables above?
  // Explain. firstName I decided to do at as variable name by using quotes, isHungry I made as a variable string with quotes, and
  //numberOfPets I used a numeric data type as an equation
